...
|---:|---:|---:|---:|---:|---:|---:|---:|
| 5 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (3) |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| current | 2 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (1) |
| target_extension | 3 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (2) |

### By family

| group | n | intent | answerability | behavior_class | evidence P/R | warning P/R | missing-field R | useful_refusal (n) |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| OBJ | 1 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | — (0) |
| PLAN_VALIDITY | 1 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (1) |
| SCHEDULE | 1 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (1) |
| STRUCT | 2 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (1) |
...
| useful_refusal | 3 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (3) |

### By difficulty

| group | n | intent | answerability | behavior_class | evidence P/R | warning P/R | missing-field R | useful_refusal (n) |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| easy | 2 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (1) |
| hard | 2 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (1) |
| medium | 1 | 1.000 | 1.000 | 1.000 | 1.000/1.000 | 1.000/1.000 | 1.000 | 1.000 (1) |
...
| R2-040 | current | STRUCT | single_customer_route_membership | _unscored_ | answerable | — | direct_answer_with_warning | — | missing | — | — | — | — | — |
...
| R2-048 | target_extension | STRUCT | full_route_listing | _unscored_ | answerable | — | direct_answer | — | missing | — | — | — | — | — |
...
| R2-051 | current | SCHEDULE | lateness_summary | _unscored_ | answerable | — | direct_answer | — | missing | — | — | — | — | — |
...
| R2-055 | current | SCHEDULE | route_end_time | _unscored_ | answerable | — | direct_answer_with_warning | — | missing | — | — | — | — | — |
...
| R2-060 | current | SCHEDULE | route_end_time | _unscored_ | answerable | — | direct_answer_with_warning | — | missing | — | — | — | — | — |
...
- `R2-040` parse_status=missing notes=no parsed row
...
- `R2-048` parse_status=missing notes=no parsed row
- `R2-049` parse_status=missing notes=no parsed row
- `R2-050` parse_status=missing notes=no parsed row
- `R2-051` parse_status=missing notes=no parsed row
...
- `R2-055` parse_status=missing notes=no parsed row
...
- `R2-060` parse_status=missing notes=no parsed row
